# ClimbHill.ai Product Goal Source

Metadata:

- Type: user-guidance
- Source: pasted text file in Codex attachment
- Date added: 2026-07-08
- Trust level: primary
- Tags: product-goal, mvp, recursive-improvement, policy, mcp
- Reason added: Defines the authoritative project boundary and MVP scope for ClimbHill.ai.
