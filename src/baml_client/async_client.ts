...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async DeriveSource(
        content: string,resource_id: string,locator_guidance: string,resolved_prompt: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.DerivationResult> {
          try {
          ...
          const __stream__ = this.stream.DeriveSource(
          content,resource_id,locator_guidance,resolved_prompt,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.DerivationResult
            } catch (error) {
        ...
        async PlanResearch(
        question: string,local_corpus: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ResearchPlan> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.PlanResearch(
          question,local_corpus,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.ResearchPlan
            } catch (error) {
            throw toBamlError(error);
            }
            }
        ...
        question: string,local_concepts: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.CitedAnswer> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.SynthesizeResearch(
          question,local_concepts,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.CitedAnswer
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            content: string,resource_id: string,locator_guidance: string,resolved_prompt: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.DerivationResult, types.DerivationResult>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for DeriveSource", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.DerivationResult, types.DerivationResult>(
                  __raw__,
                  (a): partial_types.DerivationResult => a,
                  (a): types.DerivationResult => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            question: string,local_corpus: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ResearchPlan, types.ResearchPlan>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for PlanResearch", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ResearchPlan, types.ResearchPlan>(
                  __raw__,
                  (a): partial_types.ResearchPlan => a,
                  (a): types.ResearchPlan => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            question: string,local_concepts: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.CitedAnswer, types.CitedAnswer>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for SynthesizeResearch", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.CitedAnswer, types.CitedAnswer>(
                  __raw__,
                  (a): partial_types.CitedAnswer => a,
                  (a): types.CitedAnswer => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
